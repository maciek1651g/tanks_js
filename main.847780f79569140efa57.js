...
/***/ "./src/js/gameObjects/chest.ts":
/*!*************************************!*\
  !*** ./src/js/gameObjects/chest.ts ***!
  \*************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Chest = void 0;\nvar phaser_1 = __webpack_require__(/*! phaser */ \"./node_modules/phaser/dist/phaser.js\");\nvar consts_1 = __webpack_require__(/*! ../../consts */ \"./src/consts.ts\");\nvar Chest = /** @class */ (function (_super) {\n    __extends(Chest, _super);\n    function Chest(scene, x, y, chestId) {\n        var _this = _super.call(this, scene, x, y, 'tiles_spr', 595) || this;\n        _this.setScale(1.5);\n        scene.add.existing(_this);\n        scene.physics.add.existing(_this);\n        _this.chestId = chestId;\n        _this.initCollision();\n        return _this;\n    }\n    Chest.prototype.initCollision = function () {\n        var _this = this;\n        var player = this.scene.player;\n        this.scene.physics.add.overlap(player, this, function (obj1, obj2) {\n            _this.scene.game.events.emit(consts_1.EVENTS_NAME.chestLoot);\n            obj2.destroy();\n            window.connection.send({ id: _this.chestId, messageType: 'chest_grab' });\n        });\n    };\n    Chest.prototype.deleteChest = function () {\n        this.destroy(true);\n    };\n    return Chest;\n}(phaser_1.Physics.Arcade.Sprite));\nexports.Chest = Chest;\n\n\n//# sourceURL=webpack://tanks_js/./src/js/gameObjects/chest.ts?");
...
eval("\nvar __assign = (this && this.__assign) || function () {\n    __assign = Object.assign || function(t) {\n        for (var s, i = 1, n = arguments.length; i < n; i++) {\n            s = arguments[i];\n            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))\n                t[p] = s[p];\n        }\n        return t;\n    };\n    return __assign.apply(this, arguments);\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Connection = exports.uid = void 0;\nvar otherPlayer_1 = __webpack_require__(/*! ./otherPlayer */ \"./src/js/gameObjects/otherPlayer.ts\");\nvar player_1 = __webpack_require__(/*! ./player */ \"./src/js/gameObjects/player.ts\");\nvar chest_1 = __webpack_require__(/*! ./chest */ \"./src/js/gameObjects/chest.ts\");\nvar uid = function () {\n    return Date.now().toString(36) + Math.random().toString(36).substr(2);\n};\nexports.uid = uid;\nvar Connection = /** @class */ (function () {\n    function Connection() {\n        this.syncObjects = new Map();\n        this.localStorage = window.sessionStorage;\n        this.initLocalData();\n    }\n    Connection.prototype.send = function (message) {\n        var _a;\n        if (((_a = this.socket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocket.OPEN) {\n            var messageDTO = {\n                messageType: message.messageType,\n                data: JSON.stringify(message),\n            };\n            this.socket.send(JSON.stringify(messageDTO));\n        }\n    };\n    Connection.prototype.close = function () {\n        if (this.socket.readyState === WebSocket.OPEN) {\n            this.socket.close();\n        }\n    };\n    Connection.prototype.initScene = function (scene) {\n        this.scene = scene;\n        this.startConnection();\n        return new player_1.Player(scene, this.gamePlayerData.coordinates.x, this.gamePlayerData.coordinates.y, this.gamePlayerData.id);\n    };\n    Connection.prototype.startConnection = function () {\n        this.initConnection();\n        this.initCallbacks();\n    };\n    Connection.prototype.initLocalData = function () {\n        var data = this.localStorage.getItem('game_player_data');\n        if (data) {\n            this.gamePlayerData = JSON.parse(data);\n        }\n        else {\n            this.gamePlayerData = {\n                id: (0, exports.uid)(),\n                coordinates: { x: 200, y: 600, directionX: 1 },\n                health: 100,\n                directionX: 1,\n            };\n            this.localStorage.setItem('game_player_data', JSON.stringify(this.gamePlayerData));\n        }\n    };\n    Connection.prototype.initConnection = function () {\n        var hostname = window.location.hostname;\n        var port = '';\n        var protocol = 'wss';\n        if (hostname === 'localhost') {\n            port = ':8080';\n            protocol = 'ws';\n        }\n        else if (window.location.hostname.includes('github.io')) {\n            hostname = 'tanks-maciejdominiak.b4a.run';\n        }\n        var url = \"\".concat(protocol, \"://\").concat(hostname).concat(port, \"/tanks/objects:exchange\");\n        this.socket = new WebSocket(url);\n    };\n    Connection.prototype.initCallbacks = function () {\n        var _this = this;\n        this.socket.onopen = function (ev) {\n            _this.socket.send(JSON.stringify(__assign(__assign({}, _this.gamePlayerData), { messageType: 'create_player' })));\n            console.log('connected');\n        };\n        this.socket.onmessage = function (event) {\n            try {\n                var data = JSON.parse(event.data);\n                console.log(data);\n                switch (data.messageType) {\n                    case 'create_player':\n                        _this.syncObjects.set(data.id, new otherPlayer_1.OtherPlayer(_this.scene, data.coordinates.x, data.coordinates.y, data.id));\n                        break;\n                    case 'user_disconnected':\n                        if (_this.syncObjects.has(data.id)) {\n                            _this.syncObjects.get(data.id).deletePlayer();\n                            _this.syncObjects.delete(data.id);\n                        }\n                        break;\n                    case 'status':\n                        if (!_this.syncObjects.has(data.id)) {\n                            _this.syncObjects.set(data.id, new otherPlayer_1.OtherPlayer(_this.scene, data.coordinates.x, data.coordinates.y, data.id));\n                        }\n                        else {\n                            if (_this.syncObjects.get(data.id) instanceof otherPlayer_1.OtherPlayer) {\n                                _this.syncObjects\n                                    .get(data.id)\n                                    .updatePlayer(data.coordinates.x, data.coordinates.y, data.coordinates.directionX, data.health);\n                            }\n                        }\n                        break;\n                    case 'user_attack':\n                        if (_this.syncObjects.get(data.id) instanceof otherPlayer_1.OtherPlayer) {\n                            _this.syncObjects.get(data.id).attack();\n                        }\n                        break;\n                    case 'create_chest':\n                        _this.syncObjects.set(data.id, new chest_1.Chest(_this.scene, data.coordinates.x, data.coordinates.y, data.id));\n                        break;\n                    case 'chest_destroy':\n                        if (_this.syncObjects.get(data.id) instanceof chest_1.Chest) {\n                            _this.syncObjects.get(data.id).deleteChest();\n                            _this.syncObjects.delete(data.id);\n                        }\n                        break;\n                    default:\n                        // @ts-ignore\n                        console.log(data.messageType, 'not implemented');\n                }\n            }\n            catch (e) {\n                console.log(e);\n            }\n        };\n        this.socket.onerror = function (error) {\n            console.log(error);\n        };\n        this.socket.onclose = function (close) {\n            console.log('closed');\n        };\n    };\n    return Connection;\n}());\nexports.Connection = Connection;\n\n\n//# sourceURL=webpack://tanks_js/./src/js/gameObjects/connection.ts?");
